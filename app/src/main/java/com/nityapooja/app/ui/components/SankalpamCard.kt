...
// Deity names in Telugu for sankalpam — maps puja type key to Telugu deity name
...
// Fallback: derive country from timezone prefix
...
private fun getAbroadLocationFromTimezone(timezone: String): AbroadLocationInfo {
    ...
    // Try prefix-based partial match (e.g. "America/Indiana/Indianapolis" matches "America/Indiana")
...
private fun buildSankalpamTelugu(
    ...
    // Build location line based on India vs abroad
