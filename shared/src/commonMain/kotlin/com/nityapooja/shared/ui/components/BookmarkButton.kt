...
@Composable
fun BookmarkButton(isBookmarked: Boolean, onToggle: () -> Unit, modifier: Modifier = Modifier) {
    ...
    IconButton(onClick = { justToggled = true; onToggle() }, modifier = modifier.scale(scale)) {
        Icon(
