...
fun HomeScreen(
    ...
    val morningNotificationEnabled by viewModel.morningNotification.collectAsState()
...
private fun TodayGuidanceCard(
    panchangam: com.nityapooja.shared.ui.panchangam.PanchangamData,
    modifier: Modifier = Modifier,
    fontScale: Float = 1f,
) {
    ...
    com.nityapooja.shared.ui.components.GlassmorphicCard(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f), verticalArrangement = Arrangement.spacedBy(4.dp)) {
                ...
                Text(
                    "ప్రతి రోజు ఉదయం శ్లోకం, రాహు కాల హెచ్చరికలు, పండుగ శుభాకాంక్షలు పొందండి · Get daily shloka, Rahu Kalam alerts, and festival greetings",
