...
actual fun PlatformDatePicker(
    ...
    // Use Material3 DatePickerDialog for iOS (CMP native)
        ...
        confirmButton = {
            TextButton(onClick = {
                datePickerState.selectedDateMillis?.let { millis ->
                    // Convert millis to date components
                    val days = (millis / 86400000).toInt()
                    // Simple conversion from epoch days
                    val epochDate = days + 719468 // days from year 0 to 1970
